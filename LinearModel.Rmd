...
Fit is the predict SIMS score when you have an ARM strength of 88. The lwr and the upr are the 95% confidence intervals for predicted SIMS score when ARM is 88.
...
Fit is the predict SIMS score when you have an GRIP strength of 94. The lwr and the upr are the 95% confidence intervals for predicted SIMS score when GRIP is 94.
...
$H_0$: There is no difference in how well each model fits the data between models (model2,model3)
...
The p-value is 0.000000001495.

We reject the Null hypothesis because the p value is so small. There is a difference between model2 and model3, we have statistical evidence that model 3 is better than model2.
